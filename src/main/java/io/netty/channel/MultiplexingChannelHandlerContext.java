...
final class MultiplexingChannelHandlerContext extends DefaultAttributeMap implements ChannelHandlerContext {

    volatile MultiplexingChannelHandlerContext next;
    volatile MultiplexingChannelHandlerContext prev;

    private final boolean inbound;
    private final boolean outbound;
    private final AbstractChannel channel;
    private final MultiplexingChannelPipeline pipeline;
    ...
    MultiplexingChannelHandlerContext(MultiplexingChannelPipeline pipeline, EventExecutorGroup group, String name,
    ...
    /** Invocation initiated by {@link MultiplexingChannelPipeline#teardownAll()}}. */
    void teardown() {
    ...
    private void teardown0() {
        MultiplexingChannelHandlerContext prev = this.prev;
        if (prev != null) {
    ...
    public ChannelHandlerContext fireChannelRegistered() {
        final MultiplexingChannelHandlerContext next = findContextInbound();
    ...
    public ChannelHandlerContext fireExceptionCaught(final Throwable cause) {
        ...
        final MultiplexingChannelHandlerContext next = this.next;
    ...
    public ChannelFuture bind(final SocketAddress localAddress, final ChannelPromise promise) {
        ...
        final MultiplexingChannelHandlerContext next = findContextOutbound();
        EventExecutor executor = next.executor();
        if (executor.inEventLoop()) {
    ...
    private void write(Object msg, boolean flush, ChannelPromise promise) {
        ...
        MultiplexingChannelHandlerContext next = findContextOutbound();
        EventExecutor executor = next.executor();
        if (executor.inEventLoop()) {
    ...
    private MultiplexingChannelHandlerContext findContextInbound() {
        MultiplexingChannelHandlerContext ctx = this;
        do {
            ctx = ctx.next;
        } while (!ctx.inbound);
        return ctx;
    ...
    private MultiplexingChannelHandlerContext findContextOutbound() {
        MultiplexingChannelHandlerContext ctx = this;
        do {
            ctx = ctx.prev;
        } while (!ctx.outbound);
    ...
    abstract static class AbstractWriteTask extends OneTimeTask {
        ...
        private MultiplexingChannelHandlerContext ctx;
        private Object msg;
        ...
        protected static void init(AbstractWriteTask task, MultiplexingChannelHandlerContext ctx,
        ...
        protected void write(MultiplexingChannelHandlerContext ctx, Object msg, ChannelPromise promise) {
    ...
    static final class WriteTask extends AbstractWriteTask implements SingleThreadEventLoop.NonWakeupRunnable {
        ...
        private static WriteTask newInstance(
                MultiplexingChannelHandlerContext ctx, Object msg, int size, ChannelPromise promise) {
    ...
    static final class WriteAndFlushTask extends AbstractWriteTask {
        ...
        @Override
        public void write(MultiplexingChannelHandlerContext ctx, Object msg, ChannelPromise promise) {
